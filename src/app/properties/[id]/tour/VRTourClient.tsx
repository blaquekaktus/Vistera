...
export default function VRTourClient({ property, initialRoomId }: Props) {
  ...
  useEffect(() => {
    const initialTour = initialRoomId
      ? property.vrTours.find((t) => t.id === initialRoomId) ?? property.vrTours[0]
      : property.vrTours[0];
    ...
    <div className="fixed inset-0 bg-slate-950 flex flex-col">
      ...
      <div className="flex flex-1 overflow-hidden">
        ...
        {sidebarOpen && property.vrTours.length > 1 && (
          <div className="w-52 bg-black/80 backdrop-blur-sm border-l border-white/10 flex-col overflow-y-auto hidden sm:flex">
                ...
                return (
                  ...
                  >
                    <div className="relative w-12 h-8 rounded-lg overflow-hidden flex-shrink-0 bg-slate-700">
                      <Image src={tour.thumbnailUrl} alt={roomName} fill className="object-cover" />
                    </div>
                    <div>
            ...
            return (
              <button
                ...
                className={cn(
                  ...
                  isActive ? 'bg-brand-600 text-white' : 'bg-white/10 text-white/70'
                )}
              >
                {roomName}
              </button>
