...
export default function PropertiesError({
  ...
  return (
    <div className="min-h-screen bg-slate-50 pt-20 flex items-center justify-center p-6">
      <div className="text-center max-w-sm">
        <div className="w-12 h-12 bg-red-50 rounded-2xl flex items-center justify-center mx-auto mb-4">
          <AlertTriangle className="w-6 h-6 text-red-500" />
        </div>
        <h2 className="text-xl font-bold text-slate-900 mb-2">Could not load properties</h2>
        <p className="text-sm text-slate-500 mb-6">
          There was an error fetching the listings. Please try again.
        </p>
